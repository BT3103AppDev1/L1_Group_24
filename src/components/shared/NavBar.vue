    ...
    <div class="container header-inner">
      ...
      <nav class="desktop-nav" :class="{ 'is-open': mobileOpen }">
        <template v-if="portal === 'public'">
          <RouterLink to="/clinics" class="nav-link" @click="closeMenu"
            >Clinic Directory</RouterLink
          >
          <RouterLink to="/login" class="nav-link" @click="closeMenu">Log In</RouterLink>
        </template>
        <template v-else-if="portal === 'patient'">
          <RouterLink to="/patient/dashboard" class="nav-link" @click="closeMenu"
            >Dashboard</RouterLink
          >
          <RouterLink to="/patient/records" class="nav-link" @click="closeMenu"
            >My Records</RouterLink
          >
          ...
          <button class="btn btn-outline nav-btn" type="button" @click="closeAndLogout">
            Logout
          </button>
        </template>
        <template v-else-if="portal === 'clinic'">
          <span class="welcome-text">{{ clinicName }}</span>
          <RouterLink to="/clinic/dashboard" class="nav-link" @click="closeMenu"
            >Queue Dashboard</RouterLink
          >
          <!-- Clinic-facing analytics page -->
          <RouterLink to="/clinic/post-consult" class="nav-link" @click="closeMenu"
            >Post-Consult</RouterLink
          >
          <RouterLink to="/clinic/analytics" class="nav-link" @click="closeMenu"
...
const clinicName = computed(
  () => authStore.clinic?.name || authStore.clinic?.clinicName || 'Clinic Portal',
)
