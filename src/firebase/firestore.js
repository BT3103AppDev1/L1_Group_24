...
export async function joinQueue(queueData) {
    ...
    // Read current queue sub-doc to get ticket counter and active count
    ...
    // Safely increment counters (creates the sub-doc if it doesn't exist yet)
...
export function subscribeToClinicServiceTickets(clinicId, serviceId, callback) {
    // Use only equality filters — no orderBy — to avoid needing a composite index.
