<template>
  <PageLayout title="My Profile">
    ...
    <ConfirmDialog v-model="confirmLogout" title="Log Out?" message="Are you sure you want to log out?"
      confirm-text="Log Out" @confirm="logout" @cancel="confirmLogout = false" />
  </PageLayout>
</template>
